-- Задание №1: Создание 2-х таблиц с применением механизмов ограничения целостности
...
-- Задание №3: Создание копии базы данных, с реализацией ограничения целостности, с помощью триггера
...
-- Задание №4: Сравнение эффективности
